...
Command: npx gltfjsx@6.5.3 baby_cute_alien.glb --transform 
Files: baby_cute_alien.glb [1.28MB] > /Users/stasshokarev/Desktop/development/personal-portfolio/public/models/baby_cute_alien-transformed.glb [141.23KB] (89%)
...
export function Alien(props) {
  ...
  const { scene, animations } = useGLTF('/models/baby_cute_alien-transformed.glb')
...
useGLTF.preload('/models/baby_cute_alien-transformed.glb')
